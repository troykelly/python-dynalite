"""
  Base of all the elements found on the Dynalite panel... Area, Preset, etc.
"""
...
class Elements:
    ...
    def __init__(self, dynalite, class_, max_elements):
        self.dynalite = dynalite
        self.max_elements = max_elements
        self.elements = [class_(i, dynalite) for i in range(max_elements)]
